  ...
  return (
    <main className="pt-24 lg:pt-32">
      ...
      <section className="relative h-64 sm:h-72 overflow-hidden">
        <Image src="https://images.unsplash.com/photo-1665849050332-8d5d7e59afb6?w=1600&q=80" alt="Kandy Temple of the Tooth Sri Lanka" fill className="object-cover" priority />
